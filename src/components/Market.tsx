...
export default class Market extends React.Component<MarketProps, MarketState> {
    ...
    render() {
        const data = {
            columnDefs: [{
                ...
                headerName: 'Amount',
                field: 'amount'
            }, {headerName: 'Per', field: 'per'}, {headerName: 'PB', field: 'pb'}, {
        ...
        return (
            <div>
                ...
                <NotTransactionTimeAlert visible={this.state.showNotTransactionTimeAlert}/>
            </div>
        );
    }
    ...
    private async updateMarketData() {
        try {
            const market = await (await fetch('https://bitqbit.herokuapp.com/market/')).json();
